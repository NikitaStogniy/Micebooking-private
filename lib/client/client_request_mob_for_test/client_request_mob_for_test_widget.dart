...
class ClientRequestMobForTestWidget extends StatefulWidget {
  const ClientRequestMobForTestWidget({
    super.key,
  ...
  @override
  State<ClientRequestMobForTestWidget> createState() =>
      _ClientRequestMobForTestWidgetState();
}

class _ClientRequestMobForTestWidgetState
    extends State<ClientRequestMobForTestWidget> {
  late ClientRequestMobForTestModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ClientRequestMobForTestModel());
                        ...
                        children: [
                          ...
                          Builder(
                            builder: (context) {
                              ...
                              return Column(
                                mainAxisSize: MainAxisSize.max,
                                children: List.generate(requestsMob.length,
                                    (requestsMobIndex) {
                                  final requestsMobItem =
                                      requestsMob[requestsMobIndex];
                                  return Column(
                                    mainAxisSize: MainAxisSize.max,
                                    crossAxisAlignment:
