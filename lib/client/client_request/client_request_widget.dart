                          ...
                          FutureBuilder<List<RequestsHallVarRow>>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              List<RequestsHallVarRow>
                                  columnRequestsHallVarRowList = snapshot.data!;
                              ...
                              return Column(
                                ...
                                children: List.generate(
                                  ...
                                  final columnRequestsHallVarRow =
                                      columnRequestsHallVarRowList[columnIndex];
                                  return Container(
                                    width:
                          ...
                          FutureBuilder<List<RequestsFoodVarRow>>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              List<RequestsFoodVarRow>
                                  columnRequestsFoodVarRowList = snapshot.data!;
                              ...
                              return Column(
                                ...
                                children: List.generate(
                                  ...
                                  final columnRequestsFoodVarRow =
                                      columnRequestsFoodVarRowList[columnIndex];
                                  return Container(
                                    width:
                                        MediaQuery.sizeOf(context).width * 1.0,
                                    height: 40.0,
                          ...
                          FutureBuilder<List<RequestsRoomVarRow>>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              List<RequestsRoomVarRow>
                                  columnRequestsRoomVarRowList = snapshot.data!;
