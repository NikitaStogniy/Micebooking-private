                          ...
                          children: [
                                    ...
                                    Text(
                                      '${dateTimeFormat(
                                        ...
                                        functions.personsGen(
                                            containerRequestsRow?.peopleCount
                                                ?.toDouble()),
                                        '20',
                                      )}',
                                      style: FlutterFlowTheme.of(context)
                            ...
                            FutureBuilder<List<HotelRow>>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                List<HotelRow> columnHotelRowList =
                                    snapshot.data!;
                                final columnHotelRow =
                                    columnHotelRowList.isNotEmpty
                                ...
                                Row(
                                  ...
                                  children: [
                                    FlutterFlowIconButton(
                                      ...
                                      onPressed: () async {
                                        _model.currentDate = functions
                                            .addOrSubtractMonthFromDate(
                                ...
                                Builder(
                                  builder: (context) {
                                    ...
                                    return Column(
                                      mainAxisSize: MainAxisSize.max,
                                      children:
                                          List.generate(requestsMob.length,
                                              (requestsMobIndex) {
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: FutureBuilder<
                                          List<RequestsHallVarRow>>(
                                        future:
                                            RequestsHallVarTable().queryRows(
                                          queryFn: (q) => q.in_(
                                            'id',
                                            containerRequestsRow!.halls,
                                          ),
