...
import 'edit_terms_model.dart';
export 'edit_terms_model.dart';

class EditTermsWidget extends StatefulWidget {
  const EditTermsWidget({super.key});

  @override
  State<EditTermsWidget> createState() => _EditTermsWidgetState();
}

class _EditTermsWidgetState extends State<EditTermsWidget> {
  late EditTermsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditTermsModel());
