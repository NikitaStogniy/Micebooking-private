...
class MobileMenuWidget extends StatefulWidget {
  ...
  final Future Function()? clientRequests;
            ...
            child: Row(
              ...
              children: [
                Container(
                  ...
                  child: Padding(
                    padding:
                        const EdgeInsetsDirectional.fromSTEB(24.0, 40.0, 24.0, 40.0),
                    child: Column(
                                ...
                                children: [
                                  Expanded(
                                    child: InkWell(
                                      ...
                                      highlightColor: Colors.transparent,
                                      onTap: () async {
                                        context.pushNamed('aboutservice');
                                      },
                                      child: Text(
                                        'О сервисе',
                                ...
                                children: [
                                  Expanded(
                                    child: InkWell(
                                      ...
                                      highlightColor: Colors.transparent,
                                      onTap: () async {
                                        await widget.clientRequests?.call();
                                      },
                                      child: Text(
                                        'Запросы КП',
                                        style: FlutterFlowTheme.of(context)
                        ...
                        Column(
                          ...
                          children: [
                            FFButtonWidget(
                              ...
                              text: loggedIn ? 'Личный кабинет' : 'Войти',
