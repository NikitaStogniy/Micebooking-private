...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'HotelSearchPageCopy',
          path: '/Edit',
          builder: (context, params) => HotelSearchPageCopyWidget(
            startDate: params.getParam(
              'startDate',
              ParamType.DateTime,
            ),
            ...
            chosenHall: params.getParam<int>(
              'chosenHall',
              ParamType.int,
              isList: true,
            ),
            ...
            hallRequest: params.getParam<int>(
              'hallRequest',
              ParamType.int,
              isList: true,
            ),
            foodRequest: params.getParam<int>(
              'foodRequest',
              ParamType.int,
              isList: true,
            ),
            roomRequest: params.getParam<int>(
              'roomRequest',
              ParamType.int,
              isList: true,
            ),
